                ...
                <div class="row">
                    <div class="custom-common-column custom-column-width-66 custom-padding-5">
                        <div class="slider-area">
                            <div class="hero-slider-active-1 nav-style-1 nav-style-1-position-1 slick-initialized slick-slider">
                            
                                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2331px;"><div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-end bg-img slick-slide slick-current slick-active" style="background-image: url(&quot;assets/images/slider/hm1-slider-1.jpg&quot;); width: 777px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" data-slick-index="0" aria-hidden="false" tabindex="0">
                                    <div class="hero-slider-content-1 slider-animated-1">
                                        <h1 class="animated">사업자 관리 화면 <br>&amp; 채널과 상품을 관리하세요 </h1>
                                        <p class="animated">많은 기능 제공을 위해 발전 중입니다. </p>
                                        <div class="btn-style-1">
                                            <a class="animated" href="product-details.html" tabindex="0"> 채널 관리 </a>
                                        </div>
                                    </div>
                                ...
                                </div><div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-end slick-slide" style="background-image: url(&quot;assets/images/slider/hm1-slider-2.jpg&quot;); width: 777px; position: relative; left: -777px; top: 0px; z-index: 998; opacity: 0;" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                    <div class="hero-slider-content-1 slider-content-1-black slider-animated-1">
                                        ...
                                        <p class="animated">Backed by experience since 1950. One-stop Source for all your Hospital &amp; Medical Needs. </p>
                                        <div class="btn-style-1">
                                            <a class="animated" href="product-details.html" tabindex="-1"> Buy now </a>
                                        </div>
                                    </div>
                                    <div class="slider-product-price slider-product-position1 slider-animated-1 animated">
                                        <h3>
                                ...
                                </div><div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-end slick-slide" style="background-image: url(&quot;assets/images/slider/hm1-slider-3.jpg&quot;); width: 777px; position: relative; left: -1554px; top: 0px; z-index: 998; opacity: 0;" data-slick-index="2" aria-hidden="true" tabindex="-1">
                                    <div class="hero-slider-content-1 slider-animated-1">
                                        ...
                                        <p class="animated">3M high-efficiency electrostatic filter cotton, non-oily particle filtration efficiency ≥ 90% </p>
                                        <div class="btn-style-1">
                                            <a class="animated" href="product-details.html" tabindex="-1"> Buy now </a>
                                        </div>
                                    </div>
