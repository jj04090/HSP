...
public class User implements Serializable {
	...
	public User(String user_id, String phone, String name, String password, String address, String detail_address,
			String zip_code, String bank_name, String account_number, String auth, String regit_date, int itemStart,
			int itemSizePerPage) {
	...
	public String toString() {
		return "User [user_id=" + user_id + ", phone=" + phone + ", name=" + name + ", password=" + password
				+ ", address=" + address + ", detail_address=" + detail_address + ", zip_code=" + zip_code
				+ ", bank_name=" + bank_name + ", account_number=" + account_number + ", auth=" + auth + ", regit_date="
				+ regit_date + ", itemStart=" + itemStart + ", itemSizePerPage=" + itemSizePerPage + "]";
	}
